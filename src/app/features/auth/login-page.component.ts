      ...
      <div class="auth-panel">
        <div class="panel-content">
          ...
          <div class="panel-body">
            ...
            <p>
              La plateforme wishlist événementielle qui simplifie la vie des organisateurs et de
              leurs invités.
            </p>
          ...
          <form [formGroup]="form" (ngSubmit)="submit()" novalidate>
            ...
            <div class="field">
              ...
              @if (isInvalid('password')) {
                <span class="field-err">Mot de passe requis.</span>
              }
            </div>
  ...
  styles: [
    `
      ...
      .auth-panel {
        ...
        overflow: hidden;
        background-image:
          radial-gradient(ellipse 80% 60% at 30% 40%, rgba(255, 215, 0, 0.12) 0%, transparent 60%),
...
export class LoginPageComponent implements OnInit {
  ...
  resendVerification(): void {
    ...
    if (!email) {
      this.errorMessage = "Entrez votre email d'abord.";
      return;
    }
