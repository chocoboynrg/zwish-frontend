        ...
        <div class="form-wrap">
          ...
          <form [formGroup]="form" (ngSubmit)="submit()" novalidate>
            <div class="field">
              ...
              />
              @if (isInvalid('name')) {
                <span class="field-err">Nom requis.</span>
              }
            </div>
            ...
            <div class="field">
              ...
              />
              @if (mismatch()) {
                <span class="field-err">Les mots de passe ne correspondent pas.</span>
              }
            </div>
  ...
  styles: [
    `
      ...
      .auth-panel {
        ...
        overflow: hidden;
        background-image:
          radial-gradient(ellipse 70% 60% at 20% 30%, rgba(255, 215, 0, 0.1) 0%, transparent 55%),
