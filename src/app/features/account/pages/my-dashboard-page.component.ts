        ...
        @if (!loading() && data()) {
          ...
          <div class="stats-grid">
            ...
            <div class="stat-card stat-gold">
              <div class="stat-icon">💰</div>
              <div class="stat-value">
                {{ data()!.summary?.confirmedContributionsAmount ?? 0 | number: '1.0-0' }}
              </div>
          ...
          <div class="panels-grid">
            ...
            <div class="panel">
              ...
              @if (data()!.organizedEvents.length > 0) {
                <div class="event-list">
                  @for (e of data()!.organizedEvents.slice(0, 4); track e.id) {
                    <a [routerLink]="['/app/events', e.id]" class="event-row">
            ...
            <div class="panel">
              ...
              @if (data()!.joinedEvents.length > 0) {
                <div class="event-list">
                  @for (e of data()!.joinedEvents.slice(0, 4); track e.id) {
                    <a [routerLink]="['/app/events', e.id]" class="event-row">
