...
@Component({
  ...
  template: `
    ...
    @if (show && item) {
      <div class="modal-wrap" (click)="closeIfAllowed()">
        <div class="modal" (click)="$event.stopPropagation()">
          ...
          <div class="modal-body">
            <!-- Montants suggérés -->
            @if (getSuggestedAmounts(item).length > 0) {
              <div class="field-group">
                <div class="field-label">Montant rapide</div>
                <div class="suggested-grid">
                  @for (amt of getSuggestedAmounts(item); track amt) {
                    <button
                      class="chip-amount"
            ...
            <div class="field-group">
              <div class="field-label">
                ...
                <span class="field-hint"
                  >Max conseillé : {{ formatAmount(item.remainingAmount) }}</span
                >
              </div>
            ...
            <label class="anon-row">
              <div
                class="anon-toggle"
                [class.toggled]="contributionAnonymous"
                (click)="contributionAnonymousChange.emit(!contributionAnonymous)"
              >
              ...
              <div class="anon-text">
                ...
                <div class="anon-desc">
                  Votre nom ne sera pas visible par les autres participants
                </div>
              </div>
            </label>
            <!-- Récap -->
  ...
  styles: [
    `
      ...
      .anon-toggle.toggled .toggle-knob {
