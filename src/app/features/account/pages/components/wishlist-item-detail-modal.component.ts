...
@Component({
  ...
  template: `
    ...
    <!-- Drawer -->
    @if (show) {
      <div class="drawer" [class.open]="show">
            ...
            <div class="drawer-content">
              ...
              <div class="item-img-wrap">
                @if (selectedItem.imageUrl) {
                  <img [src]="selectedItem.imageUrl" [alt]="selectedItem.name" class="item-img" />
                }
                @if (!selectedItem.imageUrl) {
                ...
                <div class="img-badges">
                  ...
                  @if (selectedItem.fundingStatus === 'PARTIALLY_FUNDED') {
                    <span class="ibadge ibadge-partial">En cours</span>
                  }
                  @if (selectedItem.isReserved) {
                    <span class="ibadge ibadge-reserved">
              ...
              <div class="item-title-block">
                ...
                <div class="item-meta">
                  ...
                  <span
                    class="meta-pill meta-pill-status"
                    [ngClass]="getStatusClass(selectedItem.fundingStatus)"
                  >
                ...
                <div class="reserved-by-block">
                  ...
                  {{
                    selectedItem.reservedByMe
                      ? 'Réservé par vous'
                      : 'Réservé par ' + selectedItem.reservedByName
                  }}
                </div>
              }
              <!-- Financement -->
              <div class="funding-block">
                <div class="funding-header">
                  ...
                  <span
                    class="funded-pct"
                    [class.pct-green]="selectedItem.fundingStatus === 'FUNDED'"
                  >
                ...
                <div class="funding-footer">
                  @if (selectedItem.price) {
                    <div class="funding-row">
                      <span class="funding-label">Prix unitaire</span>
                      <span class="funding-val price-highlight">{{ selectedItem.price | number:'1.0-0' }} XOF</span>
                    </div>
                  }
                  <div class="funding-row">
                  ...
                  <div class="funding-row">
                    ...
                    <span
                      class="funding-val"
                      [class.val-green]="selectedItem.fundingStatus === 'FUNDED'"
                    >
                      {{
                        selectedItem.fundingStatus === 'FUNDED'
                          ? '—'
                          : formatAmount(selectedItem.remainingAmount)
                      }}
                    </span>
                  </div>
                  <div class="funding-row">
              ...
              <div class="actions-block">
                <!-- Contribuer -->
                @if (selectedItem.canContribute || selectedItem.pendingContributionByMe) {
                  <button
                ...
                <!-- Réserver -->
                @if (selectedItem.canReserve && !selectedItem.isReserved) {
                  <button
                    class="btn-reserve"
                ...
                @if (
                  !selectedItem.canContribute &&
                  !selectedItem.pendingContributionByMe &&
                  !selectedItem.canReserve &&
                  selectedItem.fundingStatus !== 'FUNDED'
                ) {
