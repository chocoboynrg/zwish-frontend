...
import { formatAmount, formatEventDate, formatRoleLabel } from './event-ui.utils';
        ...
        <div class="hero-content">
          <div class="hero-main">
            ...
            <div class="hero-extra-row">
              <div class="hero-participants-card">
                ...
                @if (isManager) {
                  <button type="button" class="hero-inline-link" (click)="openParticipants.emit()">
                    Voir participants
                  </button>
                }
              </div>
          ...
          <div class="hero-side">
            ...
            <div class="summary-card">
              ...
              <span class="summary-help"> {{ data.summary.totalItems }} item(s) </span>
            </div>
          </div>
        </div>
        @if (isManager) {
          <section class="card section-card invite-section">
            ...
            <p class="section-description">
              Partage un lien public pour permettre à d’autres personnes de rejoindre ou consulter
              l’événement selon les règles définies.
            </p>
            @if (inviteLink) {
              <div class="invite-box">
                ...
                @if (copySuccess) {
                  <p class="success-text">{{ copySuccess }}</p>
                }
              </div>
            }
            @if (inviteError) {
    ...
    `
      ...
      .hero-card {
        ...
        background:
          ...
          radial-gradient(circle at bottom left, rgba(255, 122, 89, 0.1), transparent 32%),
