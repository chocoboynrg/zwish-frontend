...
@Component({
      ...
      <div class="page-hero">
        <div class="page-hero-inner">
          ...
          <div class="hero-text">
            ...
            <p>
              Choisissez le type d'occasion, donnez-lui un nom et une date. Votre wishlist sera
            ...
            <form [formGroup]="form" (ngSubmit)="submit()" novalidate>
              ...
              <div class="form-section">
                ...
                <div class="section-content">
                  ...
                  <p class="section-desc">
                    Sélectionnez le type qui correspond le mieux à votre événement. Cela aide vos
                    invités à comprendre le contexte.
                  </p>
                  <div class="type-grid">
              ...
              <div class="form-section">
                ...
                <div class="section-content">
                  ...
                  <p class="section-desc">
                    Le titre sera visible par vos invités. Soyez précis et festif !
                  </p>
                  <div class="field">
                    ...
                    <div class="field-footer">
                      @if (isInvalid('title')) {
                        <span class="field-err">Le titre est obligatoire.</span>
                      }
                      <span
                        class="char-count"
                        [class.warn]="(form.get('title')?.value?.length ?? 0) > 80"
                      >
              ...
              <div class="form-section">
                ...
                <div class="section-content">
                  ...
                  <p class="section-desc">
                    La date est indicative — elle aide vos invités à planifier leur contribution.
                  </p>
                  <div class="field">
                    ...
                    <div class="field-footer">
                      @if (isInvalid('eventDate')) {
                        <span class="field-err">La date est obligatoire.</span>
                      }
              ...
              <div class="form-section">
                ...
                <div class="section-content">
                  ...
                  <p class="section-desc">
                    Décrivez l'ambiance, les attentes ou tout ce qui vous semble important.
                  </p>
                  <div class="field">
                    <textarea
                    ...
                    <div class="field-footer justify-end">
                      <span
                        class="char-count"
                        [class.warn]="(form.get('description')?.value?.length ?? 0) > 400"
                      >
              ...
              <!-- Étape 5 : Décideur livraison -->
              <div class="form-section">
                <div class="section-num">05</div>
                <div class="section-content">
                  <h2>Qui choisit les options de livraison ?</h2>
                  <p class="section-desc">
                    Lorsqu'un article est entièrement financé, qui sélectionne les options (emballage, livraison, etc.) ?
                  </p>
                  <div class="decider-grid">
                    <button
                      type="button"
                      class="decider-btn"
                      [class.selected]="form.get('deliveryDecider')?.value === 'ORGANIZER'"
                      (click)="form.patchValue({ deliveryDecider: 'ORGANIZER' })"
                    >
                      <span class="decider-icon">🎁</span>
                      <span class="decider-label">Organisateur</span>
                      <span class="decider-hint">Vous choisissez pour chaque article</span>
                    </button>
                    <button
                      type="button"
                      class="decider-btn"
                      [class.selected]="form.get('deliveryDecider')?.value === 'CONTRIBUTOR'"
                      (click)="form.patchValue({ deliveryDecider: 'CONTRIBUTOR' })"
                    >
                      <span class="decider-icon">👥</span>
                      <span class="decider-label">Contributeurs</span>
                      <span class="decider-hint">Chaque contributeur choisit pour son don</span>
                    </button>
                  </div>
                </div>
              </div>
          ...
          <div class="side-col">
            ...
            <div class="preview-card">
              ...
              <div class="preview-body">
                ...
                @if (form.get('description')?.value?.trim()) {
                  <div class="preview-desc">
                    {{ form.get('description')?.value | slice: 0 : 100
                    }}{{ (form.get('description')?.value?.length ?? 0) > 100 ? '…' : '' }}
                  </div>
                }
            ...
            <div class="tips-card">
              ...
              <div class="tip-item">
                ...
                <span
                  >Une <strong>wishlist vide</strong> est créée automatiquement. Ajoutez vos
                  produits depuis le catalogue juste après.</span
                >
              </div>
              <div class="tip-item">
                <div class="tip-dot"></div>
                <span
                  >Un <strong>lien de partage unique</strong> est généré pour que vos invités
                  accèdent à votre wishlist.</span
                >
              </div>
              <div class="tip-item">
                <div class="tip-dot"></div>
                <span
                  >Vous pouvez <strong>modifier</strong> le titre, la date et la description à tout
                  moment.</span
                >
              </div>
            </div>
  ...
  styles: [
    `
      ...
      .decider-btn:hover { border-color: #a5b4fc; }
      .decider-btn.selected { border-color: #6366f1; background: #fafafe; }
      .decider-icon { font-size: 1.8rem; }
      .decider-label { font-weight: 800; font-size: 0.95rem; color: #1e293b; }
      .decider-hint { font-size: 0.78rem; color: #94a3b8; line-height: 1.3; }
...
export class CreateUserEventPageComponent {
  ...
  selectType(t: (typeof EVENT_TYPES)[0]): void {
    ...
    const matchedPrefix = EVENT_TYPES.filter((e) => e.value)
      .map((e) => e.value + ' de ')
  ...
  submit(): void {
    ...
    this.eventsService
      .createEvent({
        ...
        deliveryDecider: (raw.deliveryDecider ?? 'ORGANIZER') as 'ORGANIZER' | 'CONTRIBUTOR',
      })
      .subscribe({
        next: (created) => {
