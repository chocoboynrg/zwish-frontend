      ...
      <div class="container">
        @if (loading()) {
          <div class="hero-card">
            ...
            <div class="state-text">Nous préparons les informations de l’événement.</div>
          </div>
        }
        ...
        @if (!loading() && !errorMessage() && preview(); as event) {
          <div class="hero-grid">
            <div class="hero-main">
              ...
              <p class="hero-description">
                {{
                  event.description || 'Vous avez été invité à découvrir cet événement sur ZWish.'
                }}
              </p>
              <div class="hero-meta">
                <div class="meta-card">
              ...
              @if (!successMessage()) {
                <div class="hero-actions">
                  @if (isAuthenticated()) {
                    ...
                    >
                      {{ joinLoading() ? 'Participation...' : 'Rejoindre l’événement' }}
                    </button>
                  } @else {
                    <a
                      class="primary-btn"
                  ...
                  <a routerLink="/catalog" class="secondary-btn"> Explorer le catalogue </a>
                </div>
              }
            </div>
            <div class="hero-side">
              ...
              <div class="info-card">
                <h3>Accès rapide</h3>
                <p>
                  Une fois connecté, vous pourrez rejoindre l’événement et retrouver son espace dans
        ...
        <div class="container">
          <div class="cta-card">
            <div>
              ...
              <p>
                Utilisez votre compte ZWish pour accéder à l’espace événement et participer
                simplement.
              </p>
            </div>
            @if (isAuthenticated()) {
              <button
                ...
                [disabled]="joinLoading()"
              >
                {{ joinLoading() ? 'Participation...' : 'Rejoindre maintenant' }}
              </button>
            } @else {
              <a
                class="primary-btn"
