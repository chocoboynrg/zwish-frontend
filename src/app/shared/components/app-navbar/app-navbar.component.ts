...
@Component({
  ...
  template: `
        ...
        <div class="actions">
          @if (currentUser(); as user) {
                        ...
                        >
                          ...
                          <div class="preview-content">
                            ...
                            <div class="preview-meta">
                              <span
                                class="type-pill"
                                [ngClass]="getTypePillClass(notification.type)"
                              >
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-links">
                    ...
                    <a routerLink="/app/notifications" (click)="closeAllMenus()">
                      Notifications
                      @if (unreadCount() > 0) {
                        <span class="inline-badge" [ngClass]="getUnreadBadgeClass(unreadCount())">
                          {{ formatUnreadCount(unreadCount()) }}
                        </span>
                      }
                    </a>
                    ...
                    @if (isAdmin()) {
                      <a routerLink="/admin" (click)="closeAllMenus()">Admin</a>
                    }
                  </div>
            ...
            <div class="desktop-guest-actions">
              ...
              <a routerLink="/app/events/new" class="btn btn-primary"> Créer un événement </a>
            </div>
          }
    ...
    @if (mobileMenuOpen()) {
      <div class="mobile-overlay" (click)="closeAllMenus()"></div>
    }
    ...
    <aside class="mobile-drawer" [class.open]="mobileMenuOpen()">
      <div class="mobile-drawer-inner">
        <div class="mobile-drawer-head">
          ...
          <button type="button" class="mobile-close" (click)="closeAllMenus()">✕</button>
        </div>

        <nav class="mobile-links">
          @for (item of mobileNavItems(); track item) {
            <a
              [routerLink]="item.path"
            ...
            >
              ...
              @if (item.path === '/app/notifications' && unreadCount() > 0) {
                <span
