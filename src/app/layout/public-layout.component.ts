...
@Component({
  ...
  template: `
    <div class="shell">
      <header class="topnav" [class.scrolled]="scrolled()">
        <div class="nav-inner">
          ...
          <nav class="nav-links">
            ...
            <a routerLink="/jackpots" routerLinkActive="nav-active">Cagnottes</a>
              ...
              >
                ...
                @if (avatarOpen()) {
                  <div class="nav-dropdown">
                    ...
                    <a routerLink="/app" class="nav-dropdown-item" (click)="avatarOpen.set(false)"
                      >Dashboard</a
                    >
                    <a
        ...
        <div class="mobile-menu" [class.open]="menuOpen()">
          ...
          <a routerLink="/jackpots" (click)="menuOpen.set(false)">Cagnottes</a>
          ...
          @if (!isAuthenticated()) {
            ...
            <a routerLink="/register" class="mobile-cta" (click)="menuOpen.set(false)"
              >Créer un compte</a
            >
          }
        </div>
      ...
      @if (avatarOpen()) {
        <div class="nav-overlay" (click)="avatarOpen.set(false)"></div>
      }
        ...
        <div class="footer-top">
          <div class="footer-inner">
            <div class="footer-brand-col">
              ...
              <p>
                La plateforme de wishlist événementielle moderne pour organiser vos cadeaux,
                contributions et réservations.
              </p>
            ...
            <div class="footer-links-col">
              <div class="footer-section">
                ...
                <a routerLink="/jackpots">Cagnottes</a>
